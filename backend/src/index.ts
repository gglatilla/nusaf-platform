...
import companiesRoutes from './api/v1/admin/companies/route';
import usersRoutes from './api/v1/admin/users/route';
...
import deliveryNotesRoutes from './api/v1/delivery-notes/route';
import proformaInvoicesRoutes from './api/v1/proforma-invoices/route';
import taxInvoicesRoutes from './api/v1/tax-invoices/route';
...
app.use('/api/v1/proforma-invoices', proformaInvoicesRoutes);
app.use('/api/v1/tax-invoices', taxInvoicesRoutes);
