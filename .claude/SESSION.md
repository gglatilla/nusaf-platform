...
## Status
IN_PROGRESS | 74% complete (Phase 0-2: COMPLETE, Phase 3: 3/7)
...
### Phase 3: Product List Enhancements (3/7)
...
- `backend/src/api/v1/products/route.ts` (modified - added isPublished filter support)
- `frontend/src/components/products/PublishFilterChips.tsx` (created)
- `frontend/src/lib/api.ts` (modified - added isPublished to ProductsQueryParams)
- `frontend/src/app/(portal)/catalog/page.tsx` (modified - added publish filter)
